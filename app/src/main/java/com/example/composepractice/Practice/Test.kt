...
import com.example.composepractice.Practice.MessageModel

@Composable
fun MessagesScreen(sendMessage: (MessageModel) -> Unit, messages: List<MessageModel>) {
